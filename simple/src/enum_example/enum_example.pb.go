...
func (DayOfTheWeek) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_enum_example_c18dce5767f93c87, []int{0}
}
...
func init() {
	proto.RegisterFile("enum_example/enum_example.proto", fileDescriptor_enum_example_c18dce5767f93c87)
}

var fileDescriptor_enum_example_c18dce5767f93c87 = []byte{
