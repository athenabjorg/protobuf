...
func (*ComplexMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_complex_ee415ebad9b79117, []int{0}
}
...
func (*DummyMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_complex_ee415ebad9b79117, []int{1}
}
...
func init() { proto.RegisterFile("complex/complex.proto", fileDescriptor_complex_ee415ebad9b79117) }

var fileDescriptor_complex_ee415ebad9b79117 = []byte{
